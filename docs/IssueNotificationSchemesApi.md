...
> serde_json::Value add_notifications(id, request_body)
...
> crate::models::NotificationSchemeId create_notification_scheme(request_body)
...
[**crate::models::NotificationSchemeId**](NotificationSchemeId.md)
...
> crate::models::PageBeanNotificationSchemeAndProjectMappingJsonBean get_notification_scheme_to_project_mappings(start_at, max_results, notification_scheme_id, project_id)
...
[**crate::models::PageBeanNotificationSchemeAndProjectMappingJsonBean**](PageBeanNotificationSchemeAndProjectMappingJsonBean.md)
...
> crate::models::PageBeanNotificationScheme get_notification_schemes(start_at, max_results, id, project_id, only_default, expand)
...
> serde_json::Value update_notification_scheme(id, request_body)
