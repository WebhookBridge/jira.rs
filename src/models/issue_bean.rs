...
pub struct IssueBean {
    ...
    pub changelog: Option<Box<crate::models::IssueBeanChangelog>>,
    #[serde(rename = "editmeta", skip_serializing_if = "Option::is_none")]
    pub editmeta: Option<Box<crate::models::IssueBeanEditmeta>>,
    ...
    pub fields_to_include: Option<Box<crate::models::IncludedFields>>,
    /// The ID of the issue.
    ...
    pub operations: Option<Box<crate::models::IssueBeanOperations>>,
