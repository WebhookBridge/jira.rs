...
pub struct JiraExpressionEvalRequestBeanContext {
    ...
    pub issue: Option<Box<crate::models::JiraExpressionEvalContextBeanIssue>>,
    #[serde(rename = "issues", skip_serializing_if = "Option::is_none")]
    pub issues: Option<Box<crate::models::JiraExpressionEvalContextBeanIssues>>,
    #[serde(rename = "project", skip_serializing_if = "Option::is_none")]
    pub project: Option<Box<crate::models::JiraExpressionEvalContextBeanProject>>,
...
impl JiraExpressionEvalRequestBeanContext {
    /// The context in which the Jira expression is evaluated.
    pub fn new() -> JiraExpressionEvalRequestBeanContext {
