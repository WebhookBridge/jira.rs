...
/// ComponentWithIssueCountLead : The user details for the component's lead user.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ComponentWithIssueCountLead {
...
impl ComponentWithIssueCountLead {
    /// The user details for the component's lead user.
    pub fn new() -> ComponentWithIssueCountLead {
