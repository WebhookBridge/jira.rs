...
/// SharePermissionUser : The user account ID that the filter is shared with. For a request, specify the `accountId` property for the user.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct SharePermissionUser {
    ...
    pub avatar_urls: Option<Box<crate::models::UserBeanAvatarUrls>>,
...
impl SharePermissionUser {
    /// The user account ID that the filter is shared with. For a request, specify the `accountId` property for the user.
    pub fn new() -> SharePermissionUser {
        SharePermissionUser {
            account_id: None,
            active: None,
            avatar_urls: None,
