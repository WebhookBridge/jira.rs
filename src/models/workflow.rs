...
pub struct Workflow {
    ...
    #[serde(rename = "id")]
    pub id: Box<crate::models::PublishedWorkflowId>,
    /// Whether this is the default workflow.
    #[serde(rename = "isDefault", skip_serializing_if = "Option::is_none")]
    pub is_default: Option<bool>,
    #[serde(rename = "operations", skip_serializing_if = "Option::is_none")]
    pub operations: Option<Box<crate::models::WorkflowOperations>>,
...
impl Workflow {
    ...
    pub fn new(description: String, id: crate::models::PublishedWorkflowId) -> Workflow {
        Workflow {
            created: None,
            description,
