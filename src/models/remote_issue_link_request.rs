...
pub struct RemoteIssueLinkRequest {
    ...
    pub application: Option<Box<crate::models::RemoteIssueLinkRequestApplication>>,
    ...
    #[serde(rename = "object")]
    pub object: Box<crate::models::RemoteIssueLinkObject>,
...
impl RemoteIssueLinkRequest {
    ...
    pub fn new(object: crate::models::RemoteIssueLinkObject) -> RemoteIssueLinkRequest {
