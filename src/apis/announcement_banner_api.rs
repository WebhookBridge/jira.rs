...
pub async fn get_banner(
...
) -> Result<crate::models::AnnouncementBannerConfiguration, Error<GetBannerError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBannerError> =
...
pub async fn set_banner(
    configuration: &configuration::Configuration,
    announcement_banner_configuration_update: crate::models::AnnouncementBannerConfigurationUpdate,
) -> Result<serde_json::Value, Error<SetBannerError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetBannerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
