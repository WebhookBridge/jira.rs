...
) -> Result<crate::models::PageBeanUser, Error<BulkGetUsersError>> {
...
pub async fn bulk_get_users_migration(
    ...
    username: Option<Vec<String>>,
    key: Option<Vec<String>>,
) -> Result<Vec<crate::models::UserMigrationBean>, Error<BulkGetUsersMigrationError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_users_default(
    ...
    start_at: Option<i32>,
    max_results: Option<i32>,
) -> Result<Vec<crate::models::User>, Error<GetAllUsersDefaultError>> {
    let local_var_configuration = configuration;
...
pub async fn get_user_default_columns(
    ...
    account_id: Option<&str>,
    username: Option<&str>,
) -> Result<Vec<crate::models::ColumnItem>, Error<GetUserDefaultColumnsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_user_email(
    configuration: &configuration::Configuration,
    account_id: &str,
) -> Result<crate::models::UnrestrictedUserEmail, Error<GetUserEmailError>> {
    let local_var_configuration = configuration;
...
pub async fn get_user_email_bulk(
    configuration: &configuration::Configuration,
    account_id: Vec<String>,
) -> Result<crate::models::UnrestrictedUserEmail, Error<GetUserEmailBulkError>> {
    let local_var_configuration = configuration;
...
pub async fn get_user_groups(
    ...
    username: Option<&str>,
    key: Option<&str>,
) -> Result<Vec<crate::models::GroupName>, Error<GetUserGroupsError>> {
    let local_var_configuration = configuration;
