...
pub async fn get_precomputations(
    ...
    order_by: Option<&str>,
    filter: Option<&str>,
) -> Result<crate::models::PageBeanJqlFunctionPrecomputationBean, Error<GetPrecomputationsError>> {
    ...
    if let Some(ref local_var_str) = function_key {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("functionKey".to_owned(), p.to_string()))
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPrecomputationsError> =
...
pub async fn update_precomputations(
    configuration: &configuration::Configuration,
    jql_function_precomputation_update_request_bean: crate::models::JqlFunctionPrecomputationUpdateRequestBean,
) -> Result<serde_json::Value, Error<UpdatePrecomputationsError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&jql_function_precomputation_update_request_bean);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdatePrecomputationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
