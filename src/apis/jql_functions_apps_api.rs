...
pub async fn get_precomputations(configuration: &configuration::Configuration, function_key: Option<Vec<String>>, start_at: Option<i64>, max_results: Option<i32>, order_by: Option<&str>, filter: Option<&str>) -> Result<crate::models::PageBeanJqlFunctionPrecomputationBean, Error<GetPrecomputationsError>> {
...
pub async fn update_precomputations(configuration: &configuration::Configuration, jql_function_precomputation_update_request_bean: crate::models::JqlFunctionPrecomputationUpdateRequestBean) -> Result<serde_json::Value, Error<UpdatePrecomputationsError>> {
    let local_var_configuration = configuration;
