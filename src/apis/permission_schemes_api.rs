...
pub async fn create_permission_grant(
    ...
    expand: Option<&str>,
) -> Result<crate::models::PermissionGrant, Error<CreatePermissionGrantError>> {
...
pub async fn create_permission_scheme(
    ...
    expand: Option<&str>,
) -> Result<crate::models::PermissionScheme, Error<CreatePermissionSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_permission_schemes(
    configuration: &configuration::Configuration,
    expand: Option<&str>,
) -> Result<crate::models::PermissionSchemes, Error<GetAllPermissionSchemesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_permission_scheme(
    ...
    scheme_id: i64,
    expand: Option<&str>,
) -> Result<crate::models::PermissionScheme, Error<GetPermissionSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_permission_scheme_grant(
    ...
    permission_id: i64,
    expand: Option<&str>,
) -> Result<crate::models::PermissionGrant, Error<GetPermissionSchemeGrantError>> {
    let local_var_configuration = configuration;
...
pub async fn get_permission_scheme_grants(
    ...
    scheme_id: i64,
    expand: Option<&str>,
) -> Result<crate::models::PermissionGrants, Error<GetPermissionSchemeGrantsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_permission_scheme(
    ...
    request_body: ::std::collections::HashMap<String, serde_json::Value>,
    expand: Option<&str>,
) -> Result<crate::models::PermissionScheme, Error<UpdatePermissionSchemeError>> {
    let local_var_configuration = configuration;
