...
pub async fn assign_projects_to_custom_field_context(
    ...
    field_id: &str,
    context_id: i64,
    project_ids: crate::models::ProjectIds,
...
pub async fn create_custom_field_context(
    configuration: &configuration::Configuration,
    field_id: &str,
    create_custom_field_context: crate::models::CreateCustomFieldContext,
...
pub async fn get_custom_field_contexts_for_projects_and_issue_types(
    configuration: &configuration::Configuration,
    field_id: &str,
    project_issue_type_mappings: crate::models::ProjectIssueTypeMappings,
    start_at: Option<i64>,
    max_results: Option<i32>,
) -> Result<
...
pub async fn set_default_values(
    configuration: &configuration::Configuration,
    field_id: &str,
    custom_field_context_default_value_update: crate::models::CustomFieldContextDefaultValueUpdate,
...
pub async fn update_custom_field_context(
    ...
    field_id: &str,
    context_id: i64,
    custom_field_context_update_details: crate::models::CustomFieldContextUpdateDetails,
