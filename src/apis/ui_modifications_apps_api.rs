...
pub async fn create_ui_modification(configuration: &configuration::Configuration, create_ui_modification_details: crate::models::CreateUiModificationDetails) -> Result<crate::models::UiModificationIdentifiers, Error<CreateUiModificationError>> {
...
pub async fn get_ui_modifications(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>, expand: Option<&str>) -> Result<crate::models::PageBeanUiModificationDetails, Error<GetUiModificationsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_ui_modification(configuration: &configuration::Configuration, ui_modification_id: &str, update_ui_modification_details: crate::models::UpdateUiModificationDetails) -> Result<serde_json::Value, Error<UpdateUiModificationError>> {
    let local_var_configuration = configuration;
