...
pub async fn create_ui_modification(
    configuration: &configuration::Configuration,
    create_ui_modification_details: crate::models::CreateUiModificationDetails,
) -> Result<crate::models::UiModificationIdentifiers, Error<CreateUiModificationError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateUiModificationError> =
...
pub async fn delete_ui_modification(
    configuration: &configuration::Configuration,
    ui_modification_id: &str,
) -> Result<serde_json::Value, Error<DeleteUiModificationError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        uiModificationId = crate::apis::urlencode(ui_modification_id)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteUiModificationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_ui_modifications(
    configuration: &configuration::Configuration,
    start_at: Option<i64>,
    max_results: Option<i32>,
    expand: Option<&str>,
) -> Result<crate::models::PageBeanUiModificationDetails, Error<GetUiModificationsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUiModificationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_ui_modification(
    configuration: &configuration::Configuration,
    ui_modification_id: &str,
    update_ui_modification_details: crate::models::UpdateUiModificationDetails,
) -> Result<serde_json::Value, Error<UpdateUiModificationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateUiModificationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
