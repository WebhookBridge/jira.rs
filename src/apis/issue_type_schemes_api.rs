...
pub async fn add_issue_types_to_issue_type_scheme(
    ...
    issue_type_ids: crate::models::IssueTypeIds,
...
pub async fn assign_issue_type_scheme_to_project(
    configuration: &configuration::Configuration,
    issue_type_scheme_project_association: crate::models::IssueTypeSchemeProjectAssociation,
...
pub async fn create_issue_type_scheme(
    configuration: &configuration::Configuration,
    issue_type_scheme_details: crate::models::IssueTypeSchemeDetails,
) -> Result<crate::models::IssueTypeSchemeId, Error<CreateIssueTypeSchemeError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::PageBeanIssueTypeScheme, Error<GetAllIssueTypeSchemesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_type_scheme_for_projects(
    ...
    start_at: Option<i64>,
    max_results: Option<i32>,
) -> Result<crate::models::PageBeanIssueTypeSchemeProjects, Error<GetIssueTypeSchemeForProjectsError>>
{
    let local_var_configuration = configuration;
...
) -> Result<crate::models::PageBeanIssueTypeSchemeMapping, Error<GetIssueTypeSchemesMappingError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = issue_type_scheme_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("issueTypeSchemeId".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "issueTypeSchemeId",
...
pub async fn reorder_issue_types_in_issue_type_scheme(
    configuration: &configuration::Configuration,
    issue_type_scheme_id: i64,
    order_of_issue_types: crate::models::OrderOfIssueTypes,
...
pub async fn update_issue_type_scheme(
    configuration: &configuration::Configuration,
    issue_type_scheme_id: i64,
    issue_type_scheme_update_details: crate::models::IssueTypeSchemeUpdateDetails,
