...
pub async fn create_workflow_scheme(configuration: &configuration::Configuration, workflow_scheme: crate::models::WorkflowScheme) -> Result<crate::models::WorkflowScheme, Error<CreateWorkflowSchemeError>> {
...
pub async fn delete_default_workflow(configuration: &configuration::Configuration, id: i64, update_draft_if_needed: Option<bool>) -> Result<crate::models::WorkflowScheme, Error<DeleteDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_workflow_scheme_issue_type(configuration: &configuration::Configuration, id: i64, issue_type: &str, update_draft_if_needed: Option<bool>) -> Result<crate::models::WorkflowScheme, Error<DeleteWorkflowSchemeIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_workflow_schemes(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>) -> Result<crate::models::PageBeanWorkflowScheme, Error<GetAllWorkflowSchemesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_default_workflow(configuration: &configuration::Configuration, id: i64, return_draft_if_exists: Option<bool>) -> Result<crate::models::DefaultWorkflow, Error<GetDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow(configuration: &configuration::Configuration, id: i64, workflow_name: Option<&str>, return_draft_if_exists: Option<bool>) -> Result<crate::models::IssueTypesWorkflowMapping, Error<GetWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow_scheme(configuration: &configuration::Configuration, id: i64, return_draft_if_exists: Option<bool>) -> Result<crate::models::WorkflowScheme, Error<GetWorkflowSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow_scheme_issue_type(configuration: &configuration::Configuration, id: i64, issue_type: &str, return_draft_if_exists: Option<bool>) -> Result<crate::models::IssueTypeWorkflowMapping, Error<GetWorkflowSchemeIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn set_workflow_scheme_issue_type(configuration: &configuration::Configuration, id: i64, issue_type: &str, issue_type_workflow_mapping: crate::models::IssueTypeWorkflowMapping) -> Result<crate::models::WorkflowScheme, Error<SetWorkflowSchemeIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn update_default_workflow(configuration: &configuration::Configuration, id: i64, default_workflow: crate::models::DefaultWorkflow) -> Result<crate::models::WorkflowScheme, Error<UpdateDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn update_workflow_mapping(configuration: &configuration::Configuration, id: i64, workflow_name: &str, issue_types_workflow_mapping: crate::models::IssueTypesWorkflowMapping) -> Result<crate::models::WorkflowScheme, Error<UpdateWorkflowMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn update_workflow_scheme(configuration: &configuration::Configuration, id: i64, workflow_scheme: crate::models::WorkflowScheme) -> Result<crate::models::WorkflowScheme, Error<UpdateWorkflowSchemeError>> {
    let local_var_configuration = configuration;
