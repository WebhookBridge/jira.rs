...
) -> Result<crate::models::WorkflowScheme, Error<CreateWorkflowSchemeError>> {
...
) -> Result<crate::models::WorkflowScheme, Error<DeleteDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_workflow_scheme(
    configuration: &configuration::Configuration,
    id: i64,
) -> Result<serde_json::Value, Error<DeleteWorkflowSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_workflow_scheme_issue_type(
    ...
    issue_type: &str,
    update_draft_if_needed: Option<bool>,
) -> Result<crate::models::WorkflowScheme, Error<DeleteWorkflowSchemeIssueTypeError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::PageBeanWorkflowScheme, Error<GetAllWorkflowSchemesError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::DefaultWorkflow, Error<GetDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow(
    ...
    return_draft_if_exists: Option<bool>,
) -> Result<crate::models::IssueTypesWorkflowMapping, Error<GetWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow_scheme(
    ...
    id: i64,
    return_draft_if_exists: Option<bool>,
) -> Result<crate::models::WorkflowScheme, Error<GetWorkflowSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow_scheme_issue_type(
    ...
    issue_type: &str,
    return_draft_if_exists: Option<bool>,
) -> Result<crate::models::IssueTypeWorkflowMapping, Error<GetWorkflowSchemeIssueTypeError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::WorkflowScheme, Error<SetWorkflowSchemeIssueTypeError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::WorkflowScheme, Error<UpdateDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::WorkflowScheme, Error<UpdateWorkflowMappingError>> {
    let local_var_configuration = configuration;
...
pub async fn update_workflow_scheme(
    ...
    id: i64,
    workflow_scheme: crate::models::WorkflowScheme,
) -> Result<crate::models::WorkflowScheme, Error<UpdateWorkflowSchemeError>> {
    let local_var_configuration = configuration;
