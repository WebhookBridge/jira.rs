...
) -> Result<crate::models::IssuePickerSuggestions, Error<GetIssuePickerResourceError>> {
...
) -> Result<crate::models::IssueMatches, Error<MatchIssuesError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::SearchResults, Error<SearchForIssuesUsingJqlError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::SearchResults, Error<SearchForIssuesUsingJqlPostError>> {
    let local_var_configuration = configuration;
