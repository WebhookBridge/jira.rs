...
) -> Result<crate::models::RemoteIssueLinkIdentifies, Error<CreateOrUpdateRemoteIssueLinkError>> {
...
pub async fn get_remote_issue_link_by_id(
    ...
    issue_id_or_key: &str,
    link_id: &str,
) -> Result<crate::models::RemoteIssueLink, Error<GetRemoteIssueLinkByIdError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::RemoteIssueLink, Error<GetRemoteIssueLinksError>> {
    let local_var_configuration = configuration;
