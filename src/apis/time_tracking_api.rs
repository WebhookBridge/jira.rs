...
pub async fn get_available_time_tracking_implementations(
    ...
    Vec<crate::models::TimeTrackingProvider>,
    Error<GetAvailableTimeTrackingImplementationsError>,
> {
...
pub async fn get_selected_time_tracking_implementation(
    configuration: &configuration::Configuration,
) -> Result<crate::models::TimeTrackingProvider, Error<GetSelectedTimeTrackingImplementationError>>
{
    let local_var_configuration = configuration;
...
pub async fn get_shared_time_tracking_configuration(
    configuration: &configuration::Configuration,
) -> Result<crate::models::TimeTrackingConfiguration, Error<GetSharedTimeTrackingConfigurationError>>
{
    let local_var_configuration = configuration;
...
) -> Result<crate::models::TimeTrackingConfiguration, Error<SetSharedTimeTrackingConfigurationError>>
{
    let local_var_configuration = configuration;
