...
pub async fn create_workflow_scheme_draft_from_parent(
    ...
    id: i64,
) -> Result<crate::models::WorkflowScheme, Error<CreateWorkflowSchemeDraftFromParentError>> {
...
pub async fn delete_draft_default_workflow(
    configuration: &configuration::Configuration,
    id: i64,
) -> Result<crate::models::WorkflowScheme, Error<DeleteDraftDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_workflow_scheme_draft_issue_type(
    ...
    id: i64,
    issue_type: &str,
) -> Result<crate::models::WorkflowScheme, Error<DeleteWorkflowSchemeDraftIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_draft_default_workflow(
    configuration: &configuration::Configuration,
    id: i64,
) -> Result<crate::models::DefaultWorkflow, Error<GetDraftDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::IssueTypesWorkflowMapping, Error<GetDraftWorkflowError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow_scheme_draft(
    configuration: &configuration::Configuration,
    id: i64,
) -> Result<crate::models::WorkflowScheme, Error<GetWorkflowSchemeDraftError>> {
    let local_var_configuration = configuration;
...
pub async fn get_workflow_scheme_draft_issue_type(
    ...
    id: i64,
    issue_type: &str,
) -> Result<crate::models::IssueTypeWorkflowMapping, Error<GetWorkflowSchemeDraftIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn publish_draft_workflow_scheme(
    configuration: &configuration::Configuration,
    id: i64,
    publish_draft_workflow_scheme: crate::models::PublishDraftWorkflowScheme,
    validate_only: Option<bool>,
) -> Result<(), Error<PublishDraftWorkflowSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PublishDraftWorkflowSchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::models::WorkflowScheme, Error<SetWorkflowSchemeDraftIssueTypeError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::WorkflowScheme, Error<UpdateDraftDefaultWorkflowError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::WorkflowScheme, Error<UpdateDraftWorkflowMappingError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::WorkflowScheme, Error<UpdateWorkflowSchemeDraftError>> {
    let local_var_configuration = configuration;
