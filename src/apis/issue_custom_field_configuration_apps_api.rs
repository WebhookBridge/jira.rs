...
pub async fn get_custom_field_configuration(
...
) -> Result<crate::models::PageBeanContextualConfiguration, Error<GetCustomFieldConfigurationError>>
{
    ...
    if let Some(ref local_var_str) = field_context_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("fieldContextId".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "fieldContextId",
    ...
    if let Some(ref local_var_str) = project_key_or_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("projectKeyOrId", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = issue_type_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("issueTypeId", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetCustomFieldConfigurationError> =
...
pub async fn update_custom_field_configuration(
    configuration: &configuration::Configuration,
    field_id_or_key: &str,
    custom_field_configurations: crate::models::CustomFieldConfigurations,
) -> Result<serde_json::Value, Error<UpdateCustomFieldConfigurationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateCustomFieldConfigurationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
