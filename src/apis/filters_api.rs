...
pub async fn change_filter_owner(
    configuration: &configuration::Configuration,
    id: i64,
    change_filter_owner: crate::models::ChangeFilterOwner,
) -> Result<serde_json::Value, Error<ChangeFilterOwnerError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChangeFilterOwnerError> =
...
pub async fn create_filter(
...
) -> Result<crate::models::Filter, Error<CreateFilterError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = override_share_permissions {
        local_var_req_builder = local_var_req_builder
            .query(&[("overrideSharePermissions", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
pub async fn delete_favourite_for_filter(
    ...
    id: i64,
    expand: Option<&str>,
) -> Result<crate::models::Filter, Error<DeleteFavouriteForFilterError>> {
    let local_var_configuration = configuration;
...
pub async fn get_columns(
    configuration: &configuration::Configuration,
    id: i64,
) -> Result<Vec<crate::models::ColumnItem>, Error<GetColumnsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_favourite_filters(
    configuration: &configuration::Configuration,
    expand: Option<&str>,
) -> Result<Vec<crate::models::Filter>, Error<GetFavouriteFiltersError>> {
    let local_var_configuration = configuration;
...
pub async fn get_filter(
    ...
    expand: Option<&str>,
    override_share_permissions: Option<bool>,
) -> Result<crate::models::Filter, Error<GetFilterError>> {
    let local_var_configuration = configuration;
...
pub async fn get_filters_paginated(
    ...
    expand: Option<&str>,
    override_share_permissions: Option<bool>,
) -> Result<crate::models::PageBeanFilterDetails, Error<GetFiltersPaginatedError>> {
    let local_var_configuration = configuration;
...
) -> Result<Vec<crate::models::Filter>, Error<GetMyFiltersError>> {
    let local_var_configuration = configuration;
...
pub async fn set_favourite_for_filter(
    ...
    id: i64,
    expand: Option<&str>,
) -> Result<crate::models::Filter, Error<SetFavouriteForFilterError>> {
    let local_var_configuration = configuration;
...
pub async fn update_filter(
    ...
    expand: Option<&str>,
    override_share_permissions: Option<bool>,
) -> Result<crate::models::Filter, Error<UpdateFilterError>> {
    let local_var_configuration = configuration;
