...
pub async fn create_component(
    ...
    project_component: crate::models::ProjectComponent,
) -> Result<crate::models::ProjectComponent, Error<CreateComponentError>> {
...
pub async fn get_component(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<crate::models::ProjectComponent, Error<GetComponentError>> {
    let local_var_configuration = configuration;
...
pub async fn get_component_related_issues(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<crate::models::ComponentIssuesCount, Error<GetComponentRelatedIssuesError>> {
    let local_var_configuration = configuration;
...
) -> Result<Vec<crate::models::ProjectComponent>, Error<GetProjectComponentsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project_components_paginated(
    ...
    order_by: Option<&str>,
    query: Option<&str>,
) -> Result<crate::models::PageBeanComponentWithIssueCount, Error<GetProjectComponentsPaginatedError>>
{
    let local_var_configuration = configuration;
...
pub async fn update_component(
    ...
    id: &str,
    project_component: crate::models::ProjectComponent,
) -> Result<crate::models::ProjectComponent, Error<UpdateComponentError>> {
    let local_var_configuration = configuration;
