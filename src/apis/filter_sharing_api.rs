...
) -> Result<Vec<crate::models::SharePermission>, Error<AddSharePermissionError>> {
...
pub async fn get_default_share_scope(
    configuration: &configuration::Configuration,
) -> Result<crate::models::DefaultShareScope, Error<GetDefaultShareScopeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_share_permission(
    ...
    id: i64,
    permission_id: i64,
) -> Result<crate::models::SharePermission, Error<GetSharePermissionError>> {
    let local_var_configuration = configuration;
...
pub async fn get_share_permissions(
    configuration: &configuration::Configuration,
    id: i64,
) -> Result<Vec<crate::models::SharePermission>, Error<GetSharePermissionsError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::DefaultShareScope, Error<SetDefaultShareScopeError>> {
    let local_var_configuration = configuration;
