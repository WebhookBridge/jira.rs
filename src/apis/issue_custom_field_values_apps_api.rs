...
pub async fn update_custom_field_value(
    ...
    field_id_or_key: &str,
    custom_field_value_update_details: crate::models::CustomFieldValueUpdateDetails,
...
pub async fn update_multiple_custom_field_values(
    configuration: &configuration::Configuration,
    multiple_custom_field_values_update_details: crate::models::MultipleCustomFieldValuesUpdateDetails,
    generate_changelog: Option<bool>,
