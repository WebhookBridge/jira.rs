...
) -> Result<crate::models::Permissions, Error<GetAllPermissionsError>> {
...
) -> Result<crate::models::BulkPermissionGrants, Error<GetBulkPermissionsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_my_permissions(
...
) -> Result<crate::models::Permissions, Error<GetMyPermissionsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = comment_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("commentId", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
) -> Result<crate::models::PermittedProjects, Error<GetPermittedProjectsError>> {
    let local_var_configuration = configuration;
