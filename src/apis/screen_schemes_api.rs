...
pub async fn create_screen_scheme(
    ...
    screen_scheme_details: crate::models::ScreenSchemeDetails,
) -> Result<crate::models::ScreenSchemeId, Error<CreateScreenSchemeError>> {
...
pub async fn delete_screen_scheme(
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        screenSchemeId = crate::apis::urlencode(screen_scheme_id)
    );
    let mut local_var_req_builder =
...
pub async fn get_screen_schemes(
    ...
    order_by: Option<&str>,
) -> Result<crate::models::PageBeanScreenScheme, Error<GetScreenSchemesError>> {
    let local_var_configuration = configuration;
...
pub async fn update_screen_scheme(
    configuration: &configuration::Configuration,
    screen_scheme_id: &str,
    update_screen_scheme_details: crate::models::UpdateScreenSchemeDetails,
