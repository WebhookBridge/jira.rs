...
pub async fn delete_workflow_transition_rule_configurations(
    configuration: &configuration::Configuration,
    workflows_with_transition_rules_details: crate::models::WorkflowsWithTransitionRulesDetails,
) -> Result<
    crate::models::WorkflowTransitionRulesUpdateErrors,
    Error<DeleteWorkflowTransitionRuleConfigurationsError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteWorkflowTransitionRuleConfigurationsError> =
...
pub async fn get_workflow_transition_rule_configurations(
    ...
    crate::models::PageBeanWorkflowTransitionRules,
    ...
    if let Some(ref local_var_str) = workflow_names {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("workflowNames".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "workflowNames",
    ...
    if let Some(ref local_var_str) = with_tags {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("withTags".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "withTags",
