...
pub async fn delete_workflow_transition_rule_configurations(configuration: &configuration::Configuration, workflows_with_transition_rules_details: crate::models::WorkflowsWithTransitionRulesDetails) -> Result<crate::models::WorkflowTransitionRulesUpdateErrors, Error<DeleteWorkflowTransitionRuleConfigurationsError>> {
...
pub async fn get_workflow_transition_rule_configurations(configuration: &configuration::Configuration, types: Vec<String>, start_at: Option<i64>, max_results: Option<i32>, keys: Option<Vec<String>>, workflow_names: Option<Vec<String>>, with_tags: Option<Vec<String>>, draft: Option<bool>, expand: Option<&str>) -> Result<crate::models::PageBeanWorkflowTransitionRules, Error<GetWorkflowTransitionRuleConfigurationsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_workflow_transition_rule_configurations(configuration: &configuration::Configuration, workflow_transition_rules_update: crate::models::WorkflowTransitionRulesUpdate) -> Result<crate::models::WorkflowTransitionRulesUpdateErrors, Error<UpdateWorkflowTransitionRuleConfigurationsError>> {
    let local_var_configuration = configuration;
