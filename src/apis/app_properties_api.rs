...
pub async fn addon_properties_resource_period_delete_app_property_delete(
    configuration: &configuration::Configuration,
    property_key: &str,
) -> Result<(), Error<AddonPropertiesResourcePeriodDeleteAppPropertyDeleteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddonPropertiesResourcePeriodDeleteAppPropertyDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn addon_properties_resource_period_put_app_property_put(
    configuration: &configuration::Configuration,
    property_key: &str,
    body: Option<serde_json::Value>,
) -> Result<
    crate::models::OperationMessage,
    Error<AddonPropertiesResourcePeriodPutAppPropertyPutError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddonPropertiesResourcePeriodPutAppPropertyPutError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
