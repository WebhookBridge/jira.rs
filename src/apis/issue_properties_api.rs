...
pub async fn bulk_set_issue_properties_by_issue(
    configuration: &configuration::Configuration,
    multi_issue_entity_properties: crate::models::MultiIssueEntityProperties,
) -> Result<(), Error<BulkSetIssuePropertiesByIssueError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<BulkSetIssuePropertiesByIssueError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn bulk_set_issues_properties_list(
    configuration: &configuration::Configuration,
    issue_entity_properties: crate::models::IssueEntityProperties,
) -> Result<(), Error<BulkSetIssuesPropertiesListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<BulkSetIssuesPropertiesListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_issue_property(
    ...
    issue_id_or_key: &str,
    property_key: &str,
) -> Result<crate::models::EntityProperty, Error<GetIssuePropertyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_property_keys(
    configuration: &configuration::Configuration,
    issue_id_or_key: &str,
) -> Result<crate::models::PropertyKeys, Error<GetIssuePropertyKeysError>> {
    let local_var_configuration = configuration;
