...
) -> Result<crate::models::IssueTypeDetails, Error<CreateIssueTypeError>> {
...
pub async fn create_issue_type_avatar(
    ...
    x: Option<i32>,
    y: Option<i32>,
) -> Result<crate::models::Avatar, Error<CreateIssueTypeAvatarError>> {
    let local_var_configuration = configuration;
...
pub async fn get_alternative_issue_types(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<Vec<crate::models::IssueTypeDetails>, Error<GetAlternativeIssueTypesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_all_types(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::IssueTypeDetails>, Error<GetIssueAllTypesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_type(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<crate::models::IssueTypeDetails, Error<GetIssueTypeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_types_for_project(
    ...
    project_id: i64,
    level: Option<i32>,
) -> Result<Vec<crate::models::IssueTypeDetails>, Error<GetIssueTypesForProjectError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetIssueTypesForProjectError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::models::IssueTypeDetails, Error<UpdateIssueTypeError>> {
    let local_var_configuration = configuration;
