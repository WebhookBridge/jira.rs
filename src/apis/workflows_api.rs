...
pub async fn create_workflow(configuration: &configuration::Configuration, create_workflow_details: crate::models::CreateWorkflowDetails) -> Result<crate::models::WorkflowIds, Error<CreateWorkflowError>> {
...
pub async fn get_all_workflows(configuration: &configuration::Configuration, workflow_name: Option<&str>) -> Result<Vec<crate::models::DeprecatedWorkflow>, Error<GetAllWorkflowsError>> {
    let local_var_configuration = configuration;
