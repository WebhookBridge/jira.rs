...
pub async fn assign_issue(configuration: &configuration::Configuration, issue_id_or_key: &str, user: crate::models::User) -> Result<serde_json::Value, Error<AssignIssueError>> {
...
pub async fn create_issue(configuration: &configuration::Configuration, request_body: ::std::collections::HashMap<String, serde_json::Value>, update_history: Option<bool>) -> Result<crate::models::CreatedIssue, Error<CreateIssueError>> {
    let local_var_configuration = configuration;
...
pub async fn create_issues(configuration: &configuration::Configuration, request_body: ::std::collections::HashMap<String, serde_json::Value>) -> Result<crate::models::CreatedIssues, Error<CreateIssuesError>> {
    let local_var_configuration = configuration;
...
pub async fn do_transition(configuration: &configuration::Configuration, issue_id_or_key: &str, request_body: ::std::collections::HashMap<String, serde_json::Value>) -> Result<serde_json::Value, Error<DoTransitionError>> {
    let local_var_configuration = configuration;
...
pub async fn edit_issue(configuration: &configuration::Configuration, issue_id_or_key: &str, request_body: ::std::collections::HashMap<String, serde_json::Value>, notify_users: Option<bool>, override_screen_security: Option<bool>, override_editable_flag: Option<bool>) -> Result<serde_json::Value, Error<EditIssueError>> {
    let local_var_configuration = configuration;
...
pub async fn get_change_logs(configuration: &configuration::Configuration, issue_id_or_key: &str, start_at: Option<i32>, max_results: Option<i32>) -> Result<crate::models::PageBeanChangelog, Error<GetChangeLogsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_change_logs_by_ids(configuration: &configuration::Configuration, issue_id_or_key: &str, issue_changelog_ids: crate::models::IssueChangelogIds) -> Result<crate::models::PageOfChangelogs, Error<GetChangeLogsByIdsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_create_issue_meta(configuration: &configuration::Configuration, project_ids: Option<Vec<String>>, project_keys: Option<Vec<String>>, issuetype_ids: Option<Vec<String>>, issuetype_names: Option<Vec<String>>, expand: Option<&str>) -> Result<crate::models::IssueCreateMetadata, Error<GetCreateIssueMetaError>> {
    let local_var_configuration = configuration;
...
pub async fn get_edit_issue_meta(configuration: &configuration::Configuration, issue_id_or_key: &str, override_screen_security: Option<bool>, override_editable_flag: Option<bool>) -> Result<crate::models::IssueUpdateMetadata, Error<GetEditIssueMetaError>> {
    let local_var_configuration = configuration;
...
pub async fn get_events(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::IssueEvent>, Error<GetEventsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue(configuration: &configuration::Configuration, issue_id_or_key: &str, fields: Option<Vec<String>>, fields_by_keys: Option<bool>, expand: Option<&str>, properties: Option<Vec<String>>, update_history: Option<bool>) -> Result<crate::models::IssueBean, Error<GetIssueError>> {
    let local_var_configuration = configuration;
...
pub async fn get_transitions(configuration: &configuration::Configuration, issue_id_or_key: &str, expand: Option<&str>, transition_id: Option<&str>, skip_remote_only_condition: Option<bool>, include_unavailable_transitions: Option<bool>, sort_by_ops_bar_and_status: Option<bool>) -> Result<crate::models::Transitions, Error<GetTransitionsError>> {
    let local_var_configuration = configuration;
...
pub async fn notify(configuration: &configuration::Configuration, issue_id_or_key: &str, request_body: ::std::collections::HashMap<String, serde_json::Value>) -> Result<serde_json::Value, Error<NotifyError>> {
    let local_var_configuration = configuration;
