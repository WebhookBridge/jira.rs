...
) -> Result<crate::models::ProjectRole, Error<CreateProjectRoleError>> {
...
pub async fn fully_update_project_role(
    ...
    id: i64,
    create_update_role_request_bean: crate::models::CreateUpdateRoleRequestBean,
) -> Result<crate::models::ProjectRole, Error<FullyUpdateProjectRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_project_roles(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::ProjectRole>, Error<GetAllProjectRolesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project_role(
...
) -> Result<crate::models::ProjectRole, Error<GetProjectRoleError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = exclude_inactive_users {
        local_var_req_builder =
            local_var_req_builder.query(&[("excludeInactiveUsers", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
pub async fn get_project_role_by_id(
    configuration: &configuration::Configuration,
    id: i64,
) -> Result<crate::models::ProjectRole, Error<GetProjectRoleByIdError>> {
    let local_var_configuration = configuration;
...
) -> Result<Vec<crate::models::ProjectRoleDetails>, Error<GetProjectRoleDetailsError>> {
    let local_var_configuration = configuration;
...
pub async fn partial_update_project_role(
    ...
    id: i64,
    create_update_role_request_bean: crate::models::CreateUpdateRoleRequestBean,
) -> Result<crate::models::ProjectRole, Error<PartialUpdateProjectRoleError>> {
    let local_var_configuration = configuration;
