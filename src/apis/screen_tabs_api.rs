...
pub async fn add_screen_tab(configuration: &configuration::Configuration, screen_id: i64, screenable_tab: crate::models::ScreenableTab) -> Result<crate::models::ScreenableTab, Error<AddScreenTabError>> {
...
pub async fn get_all_screen_tabs(configuration: &configuration::Configuration, screen_id: i64, project_key: Option<&str>) -> Result<Vec<crate::models::ScreenableTab>, Error<GetAllScreenTabsError>> {
    let local_var_configuration = configuration;
...
pub async fn rename_screen_tab(configuration: &configuration::Configuration, screen_id: i64, tab_id: i64, screenable_tab: crate::models::ScreenableTab) -> Result<crate::models::ScreenableTab, Error<RenameScreenTabError>> {
    let local_var_configuration = configuration;
