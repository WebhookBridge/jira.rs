...
pub async fn add_security_level(
    configuration: &configuration::Configuration,
    scheme_id: &str,
    add_security_scheme_levels_request_bean: crate::models::AddSecuritySchemeLevelsRequestBean,
) -> Result<serde_json::Value, Error<AddSecurityLevelError>> {
    ...
    let local_var_uri_str = format!(
        ...
        schemeId = crate::apis::urlencode(scheme_id)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddSecurityLevelError> =
...
pub async fn add_security_level_members(
    configuration: &configuration::Configuration,
    scheme_id: &str,
    level_id: &str,
    security_scheme_members_request: crate::models::SecuritySchemeMembersRequest,
) -> Result<serde_json::Value, Error<AddSecurityLevelMembersError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        schemeId = crate::apis::urlencode(scheme_id),
        levelId = crate::apis::urlencode(level_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddSecurityLevelMembersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn associate_schemes_to_projects(
    configuration: &configuration::Configuration,
    associate_security_scheme_with_project_details: crate::models::AssociateSecuritySchemeWithProjectDetails,
) -> Result<(), Error<AssociateSchemesToProjectsError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&associate_security_scheme_with_project_details);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AssociateSchemesToProjectsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_issue_security_scheme(
    configuration: &configuration::Configuration,
    request_body: ::std::collections::HashMap<String, serde_json::Value>,
) -> Result<crate::models::SecuritySchemeId, Error<CreateIssueSecuritySchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateIssueSecuritySchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_security_scheme(
    configuration: &configuration::Configuration,
    scheme_id: &str,
) -> Result<serde_json::Value, Error<DeleteSecuritySchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteSecuritySchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_issue_security_scheme(
    configuration: &configuration::Configuration,
    id: i64,
) -> Result<crate::models::SecurityScheme, Error<GetIssueSecuritySchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_security_schemes(
    configuration: &configuration::Configuration,
) -> Result<crate::models::SecuritySchemes, Error<GetIssueSecuritySchemesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_security_level_members(
    configuration: &configuration::Configuration,
    start_at: Option<&str>,
    max_results: Option<&str>,
    id: Option<Vec<String>>,
    scheme_id: Option<Vec<String>>,
    level_id: Option<Vec<String>>,
    expand: Option<&str>,
) -> Result<crate::models::PageBeanSecurityLevelMember, Error<GetSecurityLevelMembersError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = scheme_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("schemeId".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "schemeId",
    ...
    if let Some(ref local_var_str) = level_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("levelId".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "levelId",
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSecurityLevelMembersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_security_levels(
    configuration: &configuration::Configuration,
    start_at: Option<&str>,
    max_results: Option<&str>,
    id: Option<Vec<String>>,
...
) -> Result<crate::models::PageBeanSecurityLevel, Error<GetSecurityLevelsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSecurityLevelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn remove_level(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveLevelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn remove_member_from_security_level(
    configuration: &configuration::Configuration,
    scheme_id: &str,
    level_id: &str,
    member_id: &str,
) -> Result<serde_json::Value, Error<RemoveMemberFromSecurityLevelError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveMemberFromSecurityLevelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_projects_using_security_schemes(
    configuration: &configuration::Configuration,
    start_at: Option<&str>,
    max_results: Option<&str>,
    issue_security_scheme_id: Option<Vec<String>>,
    project_id: Option<Vec<String>>,
) -> Result<
    crate::models::PageBeanIssueSecuritySchemeToProjectMapping,
...
> {
    ...
    if let Some(ref local_var_str) = issue_security_scheme_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("issueSecuritySchemeId".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
    ...
    if let Some(ref local_var_str) = project_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("projectId".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "projectId",
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchProjectsUsingSecuritySchemesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_security_schemes(
    configuration: &configuration::Configuration,
    start_at: Option<&str>,
    max_results: Option<&str>,
    id: Option<Vec<String>>,
    project_id: Option<Vec<String>>,
) -> Result<crate::models::PageBeanSecuritySchemeWithProjects, Error<SearchSecuritySchemesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchSecuritySchemesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn set_default_levels(
    configuration: &configuration::Configuration,
    request_body: ::std::collections::HashMap<String, serde_json::Value>,
) -> Result<serde_json::Value, Error<SetDefaultLevelsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetDefaultLevelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_issue_security_scheme(
    configuration: &configuration::Configuration,
    id: &str,
    update_issue_security_scheme_request_bean: crate::models::UpdateIssueSecuritySchemeRequestBean,
) -> Result<serde_json::Value, Error<UpdateIssueSecuritySchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateIssueSecuritySchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_security_level(
    ...
    level_id: &str,
    request_body: ::std::collections::HashMap<String, serde_json::Value>,
) -> Result<serde_json::Value, Error<UpdateSecurityLevelError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateSecurityLevelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
