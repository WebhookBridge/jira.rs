...
pub async fn delete_webhook_by_id(
    ...
    container_for_webhook_ids: crate::models::ContainerForWebhookIds,
...
) -> Result<crate::models::PageBeanWebhook, Error<GetDynamicWebhooksForAppError>> {
    let local_var_configuration = configuration;
...
pub async fn get_failed_webhooks(
    ...
    max_results: Option<i32>,
    after: Option<i64>,
) -> Result<crate::models::FailedWebhooks, Error<GetFailedWebhooksError>> {
    let local_var_configuration = configuration;
...
pub async fn refresh_webhooks(
    configuration: &configuration::Configuration,
    container_for_webhook_ids: crate::models::ContainerForWebhookIds,
) -> Result<crate::models::WebhooksExpirationDate, Error<RefreshWebhooksError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ContainerForRegisteredWebhooks, Error<RegisterDynamicWebhooksError>> {
    let local_var_configuration = configuration;
