...
pub async fn append_mappings_for_issue_type_screen_scheme(
    ...
    issue_type_screen_scheme_mapping_details: crate::models::IssueTypeScreenSchemeMappingDetails,
...
pub async fn assign_issue_type_screen_scheme_to_project(
    configuration: &configuration::Configuration,
    issue_type_screen_scheme_project_association: crate::models::IssueTypeScreenSchemeProjectAssociation,
...
pub async fn create_issue_type_screen_scheme(
    configuration: &configuration::Configuration,
    issue_type_screen_scheme_details: crate::models::IssueTypeScreenSchemeDetails,
...
pub async fn update_default_screen_scheme(
    configuration: &configuration::Configuration,
    issue_type_screen_scheme_id: &str,
    update_default_screen_scheme: crate::models::UpdateDefaultScreenScheme,
...
pub async fn update_issue_type_screen_scheme(
    configuration: &configuration::Configuration,
    issue_type_screen_scheme_id: &str,
    issue_type_screen_scheme_update_details: crate::models::IssueTypeScreenSchemeUpdateDetails,
