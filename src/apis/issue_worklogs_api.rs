...
) -> Result<crate::models::Worklog, Error<AddWorklogError>> {
...
pub async fn get_ids_of_worklogs_deleted_since(
    configuration: &configuration::Configuration,
    since: Option<i64>,
) -> Result<crate::models::ChangedWorklogs, Error<GetIdsOfWorklogsDeletedSinceError>> {
    let local_var_configuration = configuration;
...
pub async fn get_ids_of_worklogs_modified_since(
    ...
    since: Option<i64>,
    expand: Option<&str>,
) -> Result<crate::models::ChangedWorklogs, Error<GetIdsOfWorklogsModifiedSinceError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_worklog(
    ...
    expand: Option<&str>,
) -> Result<crate::models::PageOfWorklogs, Error<GetIssueWorklogError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = started_before {
        local_var_req_builder =
            local_var_req_builder.query(&[("startedBefore", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = expand {
        local_var_req_builder =
            local_var_req_builder.query(&[("expand", &local_var_str.to_string())]);
...
pub async fn get_worklog(
    ...
    id: &str,
    expand: Option<&str>,
) -> Result<crate::models::Worklog, Error<GetWorklogError>> {
    let local_var_configuration = configuration;
...
pub async fn get_worklogs_for_ids(
    ...
    expand: Option<&str>,
) -> Result<Vec<crate::models::Worklog>, Error<GetWorklogsForIdsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_worklog(
    ...
    expand: Option<&str>,
    override_editable_flag: Option<bool>,
) -> Result<crate::models::Worklog, Error<UpdateWorklogError>> {
    let local_var_configuration = configuration;
