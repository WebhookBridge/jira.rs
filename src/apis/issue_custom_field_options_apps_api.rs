...
) -> Result<crate::models::IssueFieldOption, Error<CreateIssueFieldOptionError>> {
...
) -> Result<crate::models::PageBeanIssueFieldOption, Error<GetAllIssueFieldOptionsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_issue_field_option(
    ...
    field_key: &str,
    option_id: i64,
) -> Result<crate::models::IssueFieldOption, Error<GetIssueFieldOptionError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::PageBeanIssueFieldOption, Error<GetSelectableIssueFieldOptionsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_visible_issue_field_options(
    ...
    max_results: Option<i32>,
    project_id: Option<i64>,
) -> Result<crate::models::PageBeanIssueFieldOption, Error<GetVisibleIssueFieldOptionsError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::IssueFieldOption, Error<UpdateIssueFieldOptionError>> {
    let local_var_configuration = configuration;
