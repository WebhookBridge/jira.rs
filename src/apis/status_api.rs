...
pub async fn create_statuses(configuration: &configuration::Configuration, status_create_request: crate::models::StatusCreateRequest) -> Result<Vec<crate::models::JiraStatus>, Error<CreateStatusesError>> {
...
pub async fn delete_statuses_by_id(configuration: &configuration::Configuration, id: Option<Vec<String>>) -> Result<serde_json::Value, Error<DeleteStatusesByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_statuses_by_id(configuration: &configuration::Configuration, expand: Option<&str>, id: Option<Vec<String>>) -> Result<Vec<crate::models::JiraStatus>, Error<GetStatusesByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn search(configuration: &configuration::Configuration, expand: Option<&str>, project_id: Option<&str>, start_at: Option<i64>, max_results: Option<i32>, search_string: Option<&str>, status_category: Option<&str>) -> Result<crate::models::PageOfStatuses, Error<SearchError>> {
    let local_var_configuration = configuration;
...
pub async fn update_statuses(configuration: &configuration::Configuration, status_update_request: crate::models::StatusUpdateRequest) -> Result<serde_json::Value, Error<UpdateStatusesError>> {
    let local_var_configuration = configuration;
