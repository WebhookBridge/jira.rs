...
pub async fn assign_permission_scheme(
    ...
    expand: Option<&str>,
) -> Result<crate::models::PermissionScheme, Error<AssignPermissionSchemeError>> {
...
pub async fn get_assigned_permission_scheme(
    ...
    project_key_or_id: &str,
    expand: Option<&str>,
) -> Result<crate::models::PermissionScheme, Error<GetAssignedPermissionSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project_issue_security_scheme(
    configuration: &configuration::Configuration,
    project_key_or_id: &str,
) -> Result<crate::models::SecurityScheme, Error<GetProjectIssueSecuritySchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_security_levels_for_project(
    configuration: &configuration::Configuration,
    project_key_or_id: &str,
) -> Result<crate::models::ProjectIssueSecurityLevels, Error<GetSecurityLevelsForProjectError>> {
    let local_var_configuration = configuration;
