...
pub async fn get_approximate_application_license_count(
    configuration: &configuration::Configuration,
    application_key: &str,
) -> Result<crate::models::LicenseMetric, Error<GetApproximateApplicationLicenseCountError>> {
    ...
    let local_var_uri_str = format!(
        ...
        applicationKey = crate::apis::urlencode(application_key)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetApproximateApplicationLicenseCountError> =
...
pub async fn get_approximate_license_count(
    configuration: &configuration::Configuration,
) -> Result<crate::models::LicenseMetric, Error<GetApproximateLicenseCountError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetApproximateLicenseCountError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
