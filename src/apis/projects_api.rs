...
pub async fn create_project(
    configuration: &configuration::Configuration,
    create_project_details: crate::models::CreateProjectDetails,
) -> Result<crate::models::ProjectIdentifiers, Error<CreateProjectError>> {
    let local_var_configuration = configuration;
...
) -> Result<Vec<crate::models::Project>, Error<GetAllProjectsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_statuses(
    configuration: &configuration::Configuration,
    project_id_or_key: &str,
) -> Result<Vec<crate::models::IssueTypeWithStatus>, Error<GetAllStatusesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_hierarchy(
    configuration: &configuration::Configuration,
    project_id: i64,
) -> Result<crate::models::ProjectIssueTypeHierarchy, Error<GetHierarchyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_notification_scheme_for_project(
    ...
    expand: Option<&str>,
) -> Result<crate::models::NotificationScheme, Error<GetNotificationSchemeForProjectError>> {
    let local_var_configuration = configuration;
...
) -> Result<Vec<crate::models::Project>, Error<GetRecentError>> {
    let local_var_configuration = configuration;
...
pub async fn restore(
    configuration: &configuration::Configuration,
    project_id_or_key: &str,
) -> Result<crate::models::Project, Error<RestoreError>> {
    let local_var_configuration = configuration;
...
/// Returns a [paginated](#pagination) list of projects visible to the user.  This operation can be accessed anonymously.
...
) -> Result<crate::models::PageBeanProject, Error<SearchProjectsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_project(
    configuration: &configuration::Configuration,
    project_id_or_key: &str,
    update_project_details: crate::models::UpdateProjectDetails,
    expand: Option<&str>,
