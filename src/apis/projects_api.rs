...
pub async fn create_project(configuration: &configuration::Configuration, create_project_details: crate::models::CreateProjectDetails) -> Result<crate::models::ProjectIdentifiers, Error<CreateProjectError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_projects(configuration: &configuration::Configuration, expand: Option<&str>, recent: Option<i32>, properties: Option<Vec<String>>) -> Result<Vec<crate::models::Project>, Error<GetAllProjectsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_statuses(configuration: &configuration::Configuration, project_id_or_key: &str) -> Result<Vec<crate::models::IssueTypeWithStatus>, Error<GetAllStatusesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_hierarchy(configuration: &configuration::Configuration, project_id: i64) -> Result<crate::models::ProjectIssueTypeHierarchy, Error<GetHierarchyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_notification_scheme_for_project(configuration: &configuration::Configuration, project_key_or_id: &str, expand: Option<&str>) -> Result<crate::models::NotificationScheme, Error<GetNotificationSchemeForProjectError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project(configuration: &configuration::Configuration, project_id_or_key: &str, expand: Option<&str>, properties: Option<Vec<String>>) -> Result<crate::models::Project, Error<GetProjectError>> {
    let local_var_configuration = configuration;
...
pub async fn get_recent(configuration: &configuration::Configuration, expand: Option<&str>, properties: Option<Vec<serde_json::Value>>) -> Result<Vec<crate::models::Project>, Error<GetRecentError>> {
    let local_var_configuration = configuration;
...
pub async fn restore(configuration: &configuration::Configuration, project_id_or_key: &str) -> Result<crate::models::Project, Error<RestoreError>> {
    let local_var_configuration = configuration;
...
pub async fn search_projects(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>, order_by: Option<&str>, id: Option<Vec<i64>>, keys: Option<Vec<String>>, query: Option<&str>, type_key: Option<&str>, category_id: Option<i64>, action: Option<&str>, expand: Option<&str>, status: Option<Vec<String>>, properties: Option<Vec<serde_json::Value>>, property_query: Option<&str>) -> Result<crate::models::PageBeanProject, Error<SearchProjectsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_project(configuration: &configuration::Configuration, project_id_or_key: &str, update_project_details: crate::models::UpdateProjectDetails, expand: Option<&str>) -> Result<crate::models::Project, Error<UpdateProjectError>> {
    let local_var_configuration = configuration;
