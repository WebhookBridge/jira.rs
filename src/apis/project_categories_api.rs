...
) -> Result<crate::models::ProjectCategory, Error<CreateProjectCategoryError>> {
...
pub async fn get_all_project_categories(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::ProjectCategory>, Error<GetAllProjectCategoriesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project_category_by_id(
    configuration: &configuration::Configuration,
    id: i64,
) -> Result<crate::models::ProjectCategory, Error<GetProjectCategoryByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn update_project_category(
    ...
    id: i64,
    project_category: crate::models::ProjectCategory,
) -> Result<crate::models::UpdatedProjectCategory, Error<UpdateProjectCategoryError>> {
    let local_var_configuration = configuration;
