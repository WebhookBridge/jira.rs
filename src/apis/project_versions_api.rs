...
) -> Result<crate::models::Version, Error<CreateVersionError>> {
...
pub async fn delete_and_replace_version(
    configuration: &configuration::Configuration,
    id: &str,
    delete_and_replace_version_bean: crate::models::DeleteAndReplaceVersionBean,
...
pub async fn get_project_versions(
    ...
    expand: Option<&str>,
) -> Result<Vec<crate::models::Version>, Error<GetProjectVersionsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project_versions_paginated(
    ...
    status: Option<&str>,
    expand: Option<&str>,
) -> Result<crate::models::PageBeanVersion, Error<GetProjectVersionsPaginatedError>> {
    let local_var_configuration = configuration;
...
pub async fn get_version_related_issues(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<crate::models::VersionIssueCounts, Error<GetVersionRelatedIssuesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_version_unresolved_issues(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<crate::models::VersionUnresolvedIssuesCount, Error<GetVersionUnresolvedIssuesError>> {
    let local_var_configuration = configuration;
...
pub async fn merge_versions(
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        id = crate::apis::urlencode(id),
        moveIssuesTo = crate::apis::urlencode(move_issues_to)
    );
    let mut local_var_req_builder =
...
pub async fn move_version(
    configuration: &configuration::Configuration,
    id: &str,
    version_move_bean: crate::models::VersionMoveBean,
) -> Result<crate::models::Version, Error<MoveVersionError>> {
    let local_var_configuration = configuration;
...
pub async fn update_version(
    ...
    id: &str,
    version: crate::models::Version,
) -> Result<crate::models::Version, Error<UpdateVersionError>> {
    let local_var_configuration = configuration;
