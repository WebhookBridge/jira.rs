...
pub async fn add_gadget(configuration: &configuration::Configuration, dashboard_id: i64, dashboard_gadget_settings: crate::models::DashboardGadgetSettings) -> Result<crate::models::DashboardGadget, Error<AddGadgetError>> {
...
pub async fn copy_dashboard(configuration: &configuration::Configuration, id: &str, dashboard_details: crate::models::DashboardDetails) -> Result<crate::models::Dashboard, Error<CopyDashboardError>> {
    let local_var_configuration = configuration;
...
pub async fn create_dashboard(configuration: &configuration::Configuration, dashboard_details: crate::models::DashboardDetails) -> Result<crate::models::Dashboard, Error<CreateDashboardError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_available_dashboard_gadgets(configuration: &configuration::Configuration, ) -> Result<crate::models::AvailableDashboardGadgetsResponse, Error<GetAllAvailableDashboardGadgetsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_dashboards(configuration: &configuration::Configuration, filter: Option<&str>, start_at: Option<i32>, max_results: Option<i32>) -> Result<crate::models::PageOfDashboards, Error<GetAllDashboardsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_gadgets(configuration: &configuration::Configuration, dashboard_id: i64, module_key: Option<Vec<String>>, uri: Option<Vec<String>>, gadget_id: Option<Vec<i64>>) -> Result<crate::models::DashboardGadgetResponse, Error<GetAllGadgetsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_dashboard(configuration: &configuration::Configuration, id: &str) -> Result<crate::models::Dashboard, Error<GetDashboardError>> {
    let local_var_configuration = configuration;
...
pub async fn get_dashboard_item_property(configuration: &configuration::Configuration, dashboard_id: &str, item_id: &str, property_key: &str) -> Result<crate::models::EntityProperty, Error<GetDashboardItemPropertyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_dashboard_item_property_keys(configuration: &configuration::Configuration, dashboard_id: &str, item_id: &str) -> Result<crate::models::PropertyKeys, Error<GetDashboardItemPropertyKeysError>> {
    let local_var_configuration = configuration;
...
pub async fn update_dashboard(configuration: &configuration::Configuration, id: &str, dashboard_details: crate::models::DashboardDetails) -> Result<crate::models::Dashboard, Error<UpdateDashboardError>> {
    let local_var_configuration = configuration;
...
pub async fn update_gadget(configuration: &configuration::Configuration, dashboard_id: i64, gadget_id: i64, dashboard_gadget_update_request: crate::models::DashboardGadgetUpdateRequest) -> Result<serde_json::Value, Error<UpdateGadgetError>> {
    let local_var_configuration = configuration;
