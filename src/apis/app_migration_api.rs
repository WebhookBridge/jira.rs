...
pub async fn app_issue_field_value_update_resource_period_update_issue_fields_put(
    configuration: &configuration::Configuration,
    atlassian_transfer_id: &str,
    connect_custom_field_values: crate::models::ConnectCustomFieldValues,
) -> Result<serde_json::Value, Error<AppIssueFieldValueUpdateResourcePeriodUpdateIssueFieldsPutError>>
{
    ...
    local_var_req_builder =
        local_var_req_builder.header("Atlassian-Transfer-Id", atlassian_transfer_id.to_string());
...
pub async fn migration_resource_period_update_entity_properties_value_put(
    configuration: &configuration::Configuration,
    atlassian_transfer_id: &str,
    entity_type: &str,
    entity_property_details: Vec<crate::models::EntityPropertyDetails>,
) -> Result<(), Error<MigrationResourcePeriodUpdateEntityPropertiesValuePutError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        entityType = crate::apis::urlencode(entity_type)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationResourcePeriodUpdateEntityPropertiesValuePutError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migration_resource_period_workflow_rule_search_post(
    configuration: &configuration::Configuration,
    atlassian_transfer_id: &str,
    workflow_rules_search: crate::models::WorkflowRulesSearch,
) -> Result<
    crate::models::WorkflowRulesSearchDetails,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationResourcePeriodWorkflowRuleSearchPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
