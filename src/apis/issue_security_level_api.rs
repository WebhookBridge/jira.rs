...
pub async fn get_issue_security_level(
    ...
    id: &str,
) -> Result<crate::models::SecurityLevel, Error<GetIssueSecurityLevelError>> {
...
pub async fn get_issue_security_level_members(
    ...
    expand: Option<&str>,
) -> Result<crate::models::PageBeanIssueSecurityLevelMember, Error<GetIssueSecurityLevelMembersError>>
{
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = issue_security_level_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("issueSecurityLevelId".to_owned(), p.to_string()))
