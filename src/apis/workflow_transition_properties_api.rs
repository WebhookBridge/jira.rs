...
) -> Result<crate::models::WorkflowTransitionProperty, Error<CreateWorkflowTransitionPropertyError>>
{
...
pub async fn get_workflow_transition_properties(
    ...
    key: Option<&str>,
    workflow_mode: Option<&str>,
) -> Result<crate::models::WorkflowTransitionProperty, Error<GetWorkflowTransitionPropertiesError>>
{
    let local_var_configuration = configuration;
...
pub async fn update_workflow_transition_property(
    ...
    request_body: ::std::collections::HashMap<String, serde_json::Value>,
    workflow_mode: Option<&str>,
) -> Result<crate::models::WorkflowTransitionProperty, Error<UpdateWorkflowTransitionPropertyError>>
{
    let local_var_configuration = configuration;
