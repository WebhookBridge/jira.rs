...
pub async fn add_notifications(
...
) -> Result<serde_json::Value, Error<AddNotificationsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddNotificationsError> =
...
pub async fn create_notification_scheme(
    configuration: &configuration::Configuration,
    request_body: ::std::collections::HashMap<String, serde_json::Value>,
) -> Result<crate::models::NotificationSchemeId, Error<CreateNotificationSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateNotificationSchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_notification_scheme(
    configuration: &configuration::Configuration,
    notification_scheme_id: &str,
) -> Result<serde_json::Value, Error<DeleteNotificationSchemeError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        notificationSchemeId = crate::apis::urlencode(notification_scheme_id)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteNotificationSchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_notification_scheme(
    ...
    id: i64,
    expand: Option<&str>,
) -> Result<crate::models::NotificationScheme, Error<GetNotificationSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_notification_scheme_to_project_mappings(
    configuration: &configuration::Configuration,
    start_at: Option<&str>,
    ...
    crate::models::PageBeanNotificationSchemeAndProjectMappingJsonBean,
    Error<GetNotificationSchemeToProjectMappingsError>,
> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = notification_scheme_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("notificationSchemeId".to_owned(), p.to_string()))
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetNotificationSchemeToProjectMappingsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_notification_schemes(
    ...
    expand: Option<&str>,
) -> Result<crate::models::PageBeanNotificationScheme, Error<GetNotificationSchemesError>> {
    let local_var_configuration = configuration;
...
pub async fn remove_notification_from_notification_scheme(
    configuration: &configuration::Configuration,
    notification_scheme_id: &str,
    notification_id: &str,
) -> Result<serde_json::Value, Error<RemoveNotificationFromNotificationSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveNotificationFromNotificationSchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_notification_scheme(
    ...
    id: &str,
    request_body: ::std::collections::HashMap<String, serde_json::Value>,
) -> Result<serde_json::Value, Error<UpdateNotificationSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateNotificationSchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
