...
pub async fn add_notifications(configuration: &configuration::Configuration, id: &str, request_body: ::std::collections::HashMap<String, serde_json::Value>) -> Result<serde_json::Value, Error<AddNotificationsError>> {
...
pub async fn create_notification_scheme(configuration: &configuration::Configuration, request_body: ::std::collections::HashMap<String, serde_json::Value>) -> Result<crate::models::NotificationSchemeId, Error<CreateNotificationSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_notification_scheme(configuration: &configuration::Configuration, id: i64, expand: Option<&str>) -> Result<crate::models::NotificationScheme, Error<GetNotificationSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_notification_schemes(configuration: &configuration::Configuration, start_at: Option<&str>, max_results: Option<&str>, id: Option<Vec<String>>, project_id: Option<Vec<String>>, only_default: Option<bool>, expand: Option<&str>) -> Result<crate::models::PageBeanNotificationScheme, Error<GetNotificationSchemesError>> {
    let local_var_configuration = configuration;
...
pub async fn update_notification_scheme(configuration: &configuration::Configuration, id: &str, request_body: ::std::collections::HashMap<String, serde_json::Value>) -> Result<serde_json::Value, Error<UpdateNotificationSchemeError>> {
    let local_var_configuration = configuration;
