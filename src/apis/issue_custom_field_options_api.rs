...
pub async fn create_custom_field_option(
    ...
    field_id: &str,
    context_id: i64,
    bulk_custom_field_option_create_request: crate::models::BulkCustomFieldOptionCreateRequest,
...
pub async fn reorder_custom_field_options(
    ...
    field_id: &str,
    context_id: i64,
    order_of_custom_field_options: crate::models::OrderOfCustomFieldOptions,
...
pub async fn update_custom_field_option(
    ...
    field_id: &str,
    context_id: i64,
    bulk_custom_field_option_update_request: crate::models::BulkCustomFieldOptionUpdateRequest,
