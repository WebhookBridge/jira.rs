...
pub async fn create_priority(
...
) -> Result<crate::models::PriorityId, Error<CreatePriorityError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreatePriorityError> =
...
pub async fn delete_priority(
    ...
    id: &str,
    replace_with: &str,
) -> Result<(), Error<DeletePriorityError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeletePriorityError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_priorities(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::Priority>, Error<GetPrioritiesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_priority(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<crate::models::Priority, Error<GetPriorityError>> {
    let local_var_configuration = configuration;
...
pub async fn move_priorities(
    configuration: &configuration::Configuration,
    reorder_issue_priorities: crate::models::ReorderIssuePriorities,
) -> Result<serde_json::Value, Error<MovePrioritiesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MovePrioritiesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_priorities(
    configuration: &configuration::Configuration,
    start_at: Option<&str>,
    max_results: Option<&str>,
    id: Option<Vec<String>>,
    only_default: Option<bool>,
) -> Result<crate::models::PageBeanPriority, Error<SearchPrioritiesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchPrioritiesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn set_default_priority(
    configuration: &configuration::Configuration,
    set_default_priority_request: crate::models::SetDefaultPriorityRequest,
) -> Result<serde_json::Value, Error<SetDefaultPriorityError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetDefaultPriorityError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_priority(
    ...
    id: &str,
    request_body: ::std::collections::HashMap<String, serde_json::Value>,
) -> Result<serde_json::Value, Error<UpdatePriorityError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdatePriorityError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
