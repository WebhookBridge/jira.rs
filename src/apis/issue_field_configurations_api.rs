...
pub async fn assign_field_configuration_scheme_to_project(
    ...
    field_configuration_scheme_project_association: crate::models::FieldConfigurationSchemeProjectAssociation,
...
pub async fn create_field_configuration(
    configuration: &configuration::Configuration,
    field_configuration_details: crate::models::FieldConfigurationDetails,
) -> Result<crate::models::FieldConfiguration, Error<CreateFieldConfigurationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateFieldConfigurationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_field_configuration_scheme(
    configuration: &configuration::Configuration,
    update_field_configuration_scheme_details: crate::models::UpdateFieldConfigurationSchemeDetails,
) -> Result<crate::models::FieldConfigurationScheme, Error<CreateFieldConfigurationSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateFieldConfigurationSchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_field_configuration(
    configuration: &configuration::Configuration,
    id: i64,
) -> Result<serde_json::Value, Error<DeleteFieldConfigurationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteFieldConfigurationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_field_configuration_scheme(
    configuration: &configuration::Configuration,
    id: i64,
) -> Result<serde_json::Value, Error<DeleteFieldConfigurationSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteFieldConfigurationSchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_all_field_configuration_schemes(
    ...
    crate::models::PageBeanFieldConfigurationScheme,
    Error<GetAllFieldConfigurationSchemesError>,
> {
    let local_var_configuration = configuration;
...
pub async fn get_all_field_configurations(
    ...
    query: Option<&str>,
) -> Result<crate::models::PageBeanFieldConfigurationDetails, Error<GetAllFieldConfigurationsError>>
{
    let local_var_configuration = configuration;
...
pub async fn get_field_configuration_items(
    ...
    start_at: Option<i64>,
    max_results: Option<i32>,
) -> Result<crate::models::PageBeanFieldConfigurationItem, Error<GetFieldConfigurationItemsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_field_configuration_scheme_mappings(
    ...
    start_at: Option<i64>,
    max_results: Option<i32>,
    field_configuration_scheme_id: Option<Vec<i64>>,
) -> Result<
    crate::models::PageBeanFieldConfigurationIssueTypeItem,
    ...
    if let Some(ref local_var_str) = field_configuration_scheme_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("fieldConfigurationSchemeId".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
...
pub async fn get_field_configuration_scheme_project_mapping(
    ...
    crate::models::PageBeanFieldConfigurationSchemeProjects,
...
pub async fn remove_issue_types_from_global_field_configuration_scheme(
    configuration: &configuration::Configuration,
    id: i64,
    issue_type_ids_to_remove: crate::models::IssueTypeIdsToRemove,
) -> Result<serde_json::Value, Error<RemoveIssueTypesFromGlobalFieldConfigurationSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveIssueTypesFromGlobalFieldConfigurationSchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn set_field_configuration_scheme_mapping(
    configuration: &configuration::Configuration,
    id: i64,
    associate_field_configurations_with_issue_types_request: crate::models::AssociateFieldConfigurationsWithIssueTypesRequest,
) -> Result<serde_json::Value, Error<SetFieldConfigurationSchemeMappingError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&associate_field_configurations_with_issue_types_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetFieldConfigurationSchemeMappingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_field_configuration(
    configuration: &configuration::Configuration,
    id: i64,
    field_configuration_details: crate::models::FieldConfigurationDetails,
) -> Result<serde_json::Value, Error<UpdateFieldConfigurationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateFieldConfigurationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_field_configuration_items(
    configuration: &configuration::Configuration,
    id: i64,
    field_configuration_items_details: crate::models::FieldConfigurationItemsDetails,
) -> Result<serde_json::Value, Error<UpdateFieldConfigurationItemsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateFieldConfigurationItemsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_field_configuration_scheme(
    configuration: &configuration::Configuration,
    id: i64,
    update_field_configuration_scheme_details: crate::models::UpdateFieldConfigurationSchemeDetails,
) -> Result<serde_json::Value, Error<UpdateFieldConfigurationSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateFieldConfigurationSchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
