...
) -> Result<crate::models::ProjectRole, Error<AddActorUsersError>> {
...
) -> Result<crate::models::ProjectRole, Error<AddProjectRoleActorsToRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_project_role_actors_from_role(
    ...
    group_id: Option<&str>,
    group: Option<&str>,
) -> Result<crate::models::ProjectRole, Error<DeleteProjectRoleActorsFromRoleError>> {
    let local_var_configuration = configuration;
...
pub async fn get_project_role_actors_for_role(
    configuration: &configuration::Configuration,
    id: i64,
) -> Result<crate::models::ProjectRole, Error<GetProjectRoleActorsForRoleError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ProjectRole, Error<SetActorsError>> {
    let local_var_configuration = configuration;
