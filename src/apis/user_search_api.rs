...
) -> Result<Vec<crate::models::User>, Error<FindAssignableUsersError>> {
...
pub async fn find_bulk_assignable_users(
    ...
    start_at: Option<i32>,
    max_results: Option<i32>,
) -> Result<Vec<crate::models::User>, Error<FindBulkAssignableUsersError>> {
    let local_var_configuration = configuration;
...
pub async fn find_user_keys_by_query(
    ...
    start_at: Option<i64>,
    max_results: Option<i32>,
) -> Result<crate::models::PageBeanUserKey, Error<FindUserKeysByQueryError>> {
    let local_var_configuration = configuration;
...
pub async fn find_users(
    ...
    max_results: Option<i32>,
    property: Option<&str>,
) -> Result<Vec<crate::models::User>, Error<FindUsersError>> {
    let local_var_configuration = configuration;
...
pub async fn find_users_by_query(
    ...
    start_at: Option<i64>,
    max_results: Option<i32>,
) -> Result<crate::models::PageBeanUser, Error<FindUsersByQueryError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::FoundUsers, Error<FindUsersForPickerError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = exclude_account_ids {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("excludeAccountIds".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "excludeAccountIds",
...
pub async fn find_users_with_all_permissions(
    ...
    start_at: Option<i32>,
    max_results: Option<i32>,
) -> Result<Vec<crate::models::User>, Error<FindUsersWithAllPermissionsError>> {
    let local_var_configuration = configuration;
...
pub async fn find_users_with_browse_permission(
    ...
    start_at: Option<i32>,
    max_results: Option<i32>,
) -> Result<Vec<crate::models::User>, Error<FindUsersWithBrowsePermissionError>> {
    let local_var_configuration = configuration;
