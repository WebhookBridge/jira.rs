...
pub async fn find_bulk_assignable_users(configuration: &configuration::Configuration, project_keys: &str, query: Option<&str>, username: Option<&str>, account_id: Option<&str>, start_at: Option<i32>, max_results: Option<i32>) -> Result<Vec<crate::models::User>, Error<FindBulkAssignableUsersError>> {
    let local_var_configuration = configuration;
...
pub async fn find_user_keys_by_query(configuration: &configuration::Configuration, query: &str, start_at: Option<i64>, max_results: Option<i32>) -> Result<crate::models::PageBeanUserKey, Error<FindUserKeysByQueryError>> {
    let local_var_configuration = configuration;
...
pub async fn find_users(configuration: &configuration::Configuration, query: Option<&str>, username: Option<&str>, account_id: Option<&str>, start_at: Option<i32>, max_results: Option<i32>, property: Option<&str>) -> Result<Vec<crate::models::User>, Error<FindUsersError>> {
    let local_var_configuration = configuration;
...
pub async fn find_users_by_query(configuration: &configuration::Configuration, query: &str, start_at: Option<i64>, max_results: Option<i32>) -> Result<crate::models::PageBeanUser, Error<FindUsersByQueryError>> {
    let local_var_configuration = configuration;
...
pub async fn find_users_for_picker(configuration: &configuration::Configuration, query: &str, max_results: Option<i32>, show_avatar: Option<bool>, exclude: Option<Vec<String>>, exclude_account_ids: Option<Vec<String>>, avatar_size: Option<&str>, exclude_connect_users: Option<bool>) -> Result<crate::models::FoundUsers, Error<FindUsersForPickerError>> {
    let local_var_configuration = configuration;
...
pub async fn find_users_with_browse_permission(configuration: &configuration::Configuration, query: Option<&str>, username: Option<&str>, account_id: Option<&str>, issue_key: Option<&str>, project_key: Option<&str>, start_at: Option<i32>, max_results: Option<i32>) -> Result<Vec<crate::models::User>, Error<FindUsersWithBrowsePermissionError>> {
    let local_var_configuration = configuration;
