...
) -> Result<Vec<crate::models::ApplicationProperty>, Error<GetAdvancedSettingsError>> {
...
) -> Result<Vec<crate::models::ApplicationProperty>, Error<GetApplicationPropertyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_configuration(
    configuration: &configuration::Configuration,
) -> Result<crate::models::Configuration, Error<GetConfigurationError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ApplicationProperty, Error<SetApplicationPropertyError>> {
    let local_var_configuration = configuration;
