...
pub async fn create_screen(configuration: &configuration::Configuration, screen_details: crate::models::ScreenDetails) -> Result<crate::models::Screen, Error<CreateScreenError>> {
    let local_var_configuration = configuration;
...
pub async fn get_available_screen_fields(configuration: &configuration::Configuration, screen_id: i64) -> Result<Vec<crate::models::ScreenableField>, Error<GetAvailableScreenFieldsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_screens(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>, id: Option<Vec<i64>>, query_string: Option<&str>, scope: Option<Vec<String>>, order_by: Option<&str>) -> Result<crate::models::PageBeanScreen, Error<GetScreensError>> {
    let local_var_configuration = configuration;
...
pub async fn get_screens_for_field(configuration: &configuration::Configuration, field_id: &str, start_at: Option<i64>, max_results: Option<i32>, expand: Option<&str>) -> Result<crate::models::PageBeanScreenWithTab, Error<GetScreensForFieldError>> {
    let local_var_configuration = configuration;
...
pub async fn update_screen(configuration: &configuration::Configuration, screen_id: i64, update_screen_details: crate::models::UpdateScreenDetails) -> Result<crate::models::Screen, Error<UpdateScreenError>> {
    let local_var_configuration = configuration;
